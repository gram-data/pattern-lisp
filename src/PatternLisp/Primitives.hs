...
initialEnv = Map.fromList
  ...
  , ("record?", VPrimitive RecordType)
  , ("get", VPrimitive RecordGet)
  , ("has?", VPrimitive RecordHas)
  , ("keys", VPrimitive RecordKeys)
  , ("values", VPrimitive RecordValues)
  , ("record->alist", VPrimitive RecordToAlist)
  , ("alist->record", VPrimitive AlistToRecord)
  , ("assoc", VPrimitive RecordSet)
  , ("dissoc", VPrimitive RecordRemove)
  , ("merge", VPrimitive RecordMerge)
  , ("map", VPrimitive RecordMap)
  , ("filter", VPrimitive RecordFilter)
  ]
